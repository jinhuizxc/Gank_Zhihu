...
import com.example.jh.gank_zhihu.bean.daily.Daily;
import com.example.jh.gank_zhihu.bean.daily.HeadLine;
import com.example.jh.gank_zhihu.bean.daily.Response;
import com.example.jh.gank_zhihu.bean.zhihu.TopStories;
import com.example.jh.gank_zhihu.ui.activity.DailyFeedActivity;
...
public class DailyListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * feed_0
     */
    public class Feed_1_ViewHolder extends RecyclerView.ViewHolder {
     ...
     * feed_1
     */
    public class Feed_0_ViewHolder extends RecyclerView.ViewHolder {
    ...
    // change recycler state 用于改变recycleView的方法
